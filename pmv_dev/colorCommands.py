...
"""
    ...
    This file ePMV_git/pmv_dev/colorCommands.py is part of ePMV.
...
#
# $Header: /opt/cvs/python/packages/share1.5/Pmv/colorCommands.py,v 1.162.2.3 2011/08/18 00:24:43 sanner Exp $
#
# $Id: colorCommands.py,v 1.162.2.3 2011/08/18 00:24:43 sanner Exp $
#
"""
...
import types, string, Pmw, os, traceback
try :
    import Tkinter
except :
    import tkinter
...
##                               self.undoCmdsString )
        ...
        for g in geomsToColor:
            ...
            atmsWithGeom = atms.get(lambda x, geom=g: True if geom in x.colors else False)
...
#        print ("onAddCmdToViewer")
        ...
        if 'color' not in self.vf.commands:
            self.vf.loadCommand('colorCommands', 'color', 'Pmv',
                                topCommand=0)
        self.undoCmdsString= self.vf.color.name
#        print ("onAddCmdToViewer",self.palette)
...
#from Pmv.colorCommandsGUI import  ColorByDomainsGUI
