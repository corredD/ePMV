...
class getSymGroupCommand(MVCommand):
    """The getSymGroupCommand class is the base class to build a DNA structure from a  sequence.
    \nPackage : Pmv
    ...
    def doit(self, group, seq, **kw):
        print( group)
#        print("%s" % seq)
        self.postdicionary= {'gnum':str(group),'submit':'list',"what":"gp"}
        #setup the session
